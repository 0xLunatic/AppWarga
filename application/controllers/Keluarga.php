...
class Keluarga extends CI_Controller
{
	...
	public function anggota_keluarga()
	{
		...
		$data = array('title' => 'Sistem Informasi Warga',
					  ...
					  'data_anggota' => $this->M_Keluarga->tampil('anggota_keluarga'));
	...
	public function simpan_anggota_keluarga()
	{
		...
		$this->form_validation->set_rules('id_kk','Nomor KK','required');
		...
		if ($this->form_validation->run() != false) {
			$data = array('id_kk' => $this->input->post('id_kk'),
						  ...
						  'kewarganegaraan' => $this->input->post('alamat_kk'));
